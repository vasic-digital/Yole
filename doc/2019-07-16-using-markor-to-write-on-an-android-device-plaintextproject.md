...
Seeing as how Yole is open source, I got it (and update it) from
...
![Yole, when you first run it](https://plaintextproject.online/images/markor/markor-main-screen.png)
...
I use Yole mainly for writing. To start doing that, tap the **+** button on
the main screen. Yole prompts you for the name of your new document.
...
Yole adds the extension based on what you choose — _.md_ for Markdown and
[Jekyll](https://plaintextproject.online/2018/10/03/jekyll.html) posts, and
_.txt_ for plain text and Todo.txt files.

Yole doesn’t use templates with the file types you select. With Jekyll
posts, for example, the editor doesn’t include a [front matter](https://jekyllrb.com/docs/front-matter/) block. Yole does, however,
...
![Writing this article with Yole](https://plaintextproject.online/images/markor/writing-with-markor.png)
...
If you use Yole a lot, you’ll wind up with a lot of files. Maybe even ones
of different types or for different purposes.

A better way to organize them is to use _folders_. To create a folder, go to
Yole’s main screen and tap the **+** icon. Type a name for the folder, and
then tap **Folder**.

Create as many folders as you need. For example, I have folders for blog
posts, essays, and articles.

![Folders in Yole](https://plaintextproject.online/images/markor/markor-folders.png)
...
![Writing this article with Yole](https://plaintextproject.online/images/markor/markor-todo.png)
...
Yole’s great for writing a draft, but a time comes when you need to move a
file or three off your device to polish or publish it.

To do that, open the file in Yole. Tap the **Intents** menu and select
...
![Sharing a Yole file](https://plaintextproject.online/images/markor/markor-share.png)
...
Something I noticed: when I select _Plain Text_ , Yole doesn’t upload the
file if I change the extension to _.md_. The extension has to stay _.txt_.
It’s annoying, I agree.

## Final Thoughts

Yole has one or two little annoyances, but it’s the best free/open source
