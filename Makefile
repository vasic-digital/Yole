...
qa-iter-63-gates:
	@echo "=== iter-63 gates: LSP refactoring capabilities anti-bluff suite ==="
	bash yole-challenges/scripts/lsp_refactoring_capabilities_challenge.sh
	bash yole-challenges/scripts/lsp_workspace_edit_applier_challenge.sh
	@echo "-----------------------------------------------------------------------------------"

# iter-62 gates: 2 LSP capability-expansion anti-bluff challenges (CONST-035 + CONST-037).
qa-iter-62-gates:
	@echo "=== iter-62 gates: LSP capability expansion anti-bluff suite ==="
	bash yole-challenges/scripts/lsp_diagnostics_render_challenge.sh
	bash yole-challenges/scripts/lsp_hover_definition_challenge.sh
	@echo "-----------------------------------------------------------------------------------"
...
# Order: static-layer first (cheap, no Gradle) → runtime layer (full desktopTest suites).
qa-iter-58-gates:
	@echo "=== iter-58 gates: language-support anti-bluff suite ==="
	bash yole-challenges/scripts/language_support_completeness_challenge.sh
	bash yole-challenges/scripts/language_grammar_bundle_challenge.sh
	@echo "-----------------------------------------------------------------------------------"
