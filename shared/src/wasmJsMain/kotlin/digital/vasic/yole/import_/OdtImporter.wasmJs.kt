 ...
 * iter-64 Phase 6: OdtImporter — Web/Wasm honest stub.
 *
 * Apache ODFDOM requires a JVM; it cannot run inside a browser Wasm sandbox.
...
actual class OdtImporter actual constructor() : DocumentImporter {
    ...
    override suspend fun import(bytes: ByteArray, fileName: String): Result<ImportedDocument> =
        Result.failure(ImportError.NotSupported("odt", "Web"))
}
