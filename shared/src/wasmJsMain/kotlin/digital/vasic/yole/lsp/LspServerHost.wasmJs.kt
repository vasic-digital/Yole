...
actual class LspServerHost actual constructor(
    ...
    // iter-74: Wasm sandbox cannot spawn subprocesses — server capabilities unavailable.
    actual fun getOnTypeTriggerChars(langId: String): Set<Char>? = null
    // iter-75: Wasm sandbox cannot spawn subprocesses — jdt:// decompilation unavailable.
