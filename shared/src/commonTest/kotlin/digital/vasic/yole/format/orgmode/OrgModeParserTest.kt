...
class OrgModeParserTest {
    ...
    fun `should detect Org Mode format by extension`() {
        ...
        assertThat(format.id).isEqualTo(TextFormat.ID_ORGMODE)
    ...
    fun `should integrate with ParserRegistry`() {
        ...
        assertThat(registryParser.supportedFormat.id).isEqualTo(TextFormat.ID_ORGMODE)
    ...
    fun `should be registered in FormatRegistry`() {
        ...
        assertThat(orgModeFormat.name).isEqualTo("Org Mode")
        assertThat(orgModeFormat.defaultExtension).isEqualTo(".org")
        assertThat(orgModeFormat.extensions).contains(".org")
    }
