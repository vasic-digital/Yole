...
class TaskPaperParserTest {
    ...
    fun `should detect TaskPaper format by extension`() {
        ...
        assertThat(format.id).isEqualTo(TextFormat.ID_TASKPAPER)
        assertThat(format.name).isEqualTo("TaskPaper")
    }
    ...
    fun `should support all TaskPaper extensions`() {
        val extensions = listOf(".taskpaper", ".todo", ".txt")
    ...
    fun `should integrate with ParserRegistry`() {
        ...
        assertThat(registryParser.supportedFormat.id).isEqualTo(TextFormat.ID_TASKPAPER)
    ...
    fun `should be registered in FormatRegistry`() {
        ...
        assertThat(taskPaperFormat.name).isEqualTo("TaskPaper")
        assertThat(taskPaperFormat.defaultExtension).isEqualTo(".taskpaper")
        assertThat(taskPaperFormat.extensions).contains(".taskpaper", ".todo", ".txt")
    }
