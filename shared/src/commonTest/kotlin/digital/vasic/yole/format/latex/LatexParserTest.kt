...
class LatexParserTest {
    ...
    fun `should detect LaTeX format by extension`() {
        ...
        assertThat(format.id).isEqualTo(TextFormat.ID_LATEX)
    ...
    fun `should handle very long input`() {
        val line = "This is a test line with some LaTeX: \textbf{bold} and $math$.\n"
    ...
    fun `should integrate with ParserRegistry`() {
        ...
        assertThat(registryParser.supportedFormat.id).isEqualTo(TextFormat.ID_LATEX)
    ...
    fun `should be registered in FormatRegistry`() {
        ...
        assertThat(latexFormat.defaultExtension).isEqualTo(".tex")
        assertThat(latexFormat.extensions).contains(".tex", ".latex")
    }
    ...
    fun `should parse complex academic paper structure`() {
        ...
        assertEquals("Dr. Jane Smith \and Dr. John Doe", result.metadata["author"])
        assertEquals("article", result.metadata["documentclass"])
    }
