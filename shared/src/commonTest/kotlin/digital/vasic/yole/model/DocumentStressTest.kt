...
class DocumentStressTest {
    ...
    fun `serialization handles special characters`() = runTest {
        ...
        val specialDocs = listOf(
            Document("/path/with spaces/file.md", "file with spaces", "md"),
            Document("/path/with\"quotes\"/file.md", "file\"quotes", "md"),
            Document("/path/with\ttabs/file.md", "file\ttabs", "md"),
            Document("/path/unicode/\u00e9\u00e8\u00ea/file.md", "\u00e9\u00e8\u00ea", "md")
        )
