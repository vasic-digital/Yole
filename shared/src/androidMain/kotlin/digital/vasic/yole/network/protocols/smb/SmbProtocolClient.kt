 ...
 *
 * Android SMB client implementation using smbj.
 *
 *########################################################*/
...
/**
 * Android implementation of [SmbProtocolClient] using the smbj library.
 *
 * smbj is a pure Java library and works on the Android JVM without
 * modification. All blocking SMB operations are dispatched onto
