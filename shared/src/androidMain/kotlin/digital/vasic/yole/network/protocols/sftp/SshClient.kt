 ...
 *
 * Android SSH client implementation using sshj.
 *
 *########################################################*/
...
/**
 * Android implementation of [SshClient] using the sshj library.
 *
 * sshj is a pure Java library and works on the Android JVM without
 * modification. All blocking SSH/SFTP operations are dispatched onto
 * [Dispatchers.IO] so they do not block coroutine threads.
 */
...
/**
 * Android implementation of [SftpChannel] wrapping sshj's [SFTPClient].
 */
