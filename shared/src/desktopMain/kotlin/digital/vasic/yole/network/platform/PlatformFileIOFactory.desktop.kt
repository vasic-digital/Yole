...
/**
 * Desktop (JVM) implementation of [PlatformFileIOFactory].
 * Uses [java.io.File] for all file system operations.
 */
actual object PlatformFileIOFactory {
    actual fun create(): PlatformFileIO = DesktopFileIO()
}

/**
 * Desktop file I/O implementation using java.io.File.
 */
private class DesktopFileIO : PlatformFileIO {
