 ...
 * iter-60 Phase 2: iOS actual stub for `readSnippetResource`.
 *
 * iOS NSBundle resource access for snippet JSON files is deferred to
 * iter-60 Phase 7 (the same per-language asset-vendoring milestone as
 ...
 * NSBundle asset access for both .scm queries and snippet JSON files).
 *#######################################################*/
package digital.vasic.yole.completion.snippet

/**
 * iOS stub: returns `null` (no snippets bundled yet) until iter-60
 * Phase 7 wires NSBundle resource access for snippet JSON files.
