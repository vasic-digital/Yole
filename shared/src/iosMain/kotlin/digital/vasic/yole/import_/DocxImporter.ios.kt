 ...
 * iter-64 Phase 3: DocxImporter — iOS honest stub.
 *
 * Apache POI requires a JVM; it is not available on Kotlin/Native iOS.
...
actual class DocxImporter actual constructor() : DocumentImporter {
    ...
    override suspend fun import(bytes: ByteArray, fileName: String): Result<ImportedDocument> =
        Result.failure(ImportError.NotSupported("docx", "iOS"))
}
